...
# Coordenas para colocar na imagem da assinatura os textos.
coord_pessoa1 = (165,7)
coord_ramal = (220,29)
coord_ramal_label=(165,26) #Texto Referente ao nome ramal
coord_mail = (220,46)
coord_mail_label= (165,43) #Texto Referente ao nome email
coord_unidade=(235,62)
coord_unidade_label=(165,59) #Texto Referente ao nome unidade
coord_site=(205,79)
coord_site_label=(165,76) #Texto Referente ao nome Site
...
def gerar_assinaturas():
    try:
        ...
        font3 = ImageFont.truetype(r"C:\Windows\Fonts\Ariblk.ttf.TTF",13)
        rgb_preto = (0, 0, 0)
